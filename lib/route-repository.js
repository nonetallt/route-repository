...
class UriParameterCollection extends Array {
    constructor(...items) {
        super(...items);
    }
    /**
...
class Uri {
    ...
    constructor(uri, config = {}) {
        if (uri instanceof Map && !uri.has(UriComponent$1.Host) && !uri.has(UriComponent$1.Path)) {
    ...
    withComponent(component, value) {
        const instance = cloneDeep__default["default"](this);
...
class RouteRegistrar {
    ...
    register(name, method, uri, extra = {}) {
        ...
        let route = new Route(name, method, uriObj, merge__default["default"](this.configuration.extra, extra));
    ...
    registerAll(routes) {
        if (typeof routes === 'string') {
            try {
                routes = Object.assign(new Array(), JSON.parse(routes));
            }
            catch (error) {
...
exports.QueryParameterCollection = QueryParameterCollection;
exports.RegistrationError = RegistrationError;
exports.RequestMethod = RequestMethod$1;
exports.Route = Route;
...
exports.Uri = Uri;
exports.UriComponent = UriComponent$1;
exports.UriParameter = UriParameter;
exports.UriParameterBindingError = UriParameterBindingError;
exports.UriParameterCollection = UriParameterCollection;
exports.UriParameterSyntaxError = UriParameterSyntaxError;
exports.UriSyntaxError = UriSyntaxError;
